...
# TCL console.
   ...
   set_property -dict [list \
      CONFIG.identical_val_tx_line_rate {2.900}\
      CONFIG.identical_val_tx_reference_clock {145.000}\
      ...
      CONFIG.identical_val_rx_line_rate {2.900}\
      CONFIG.gt_val_tx_pll {PLL0}\
      CONFIG.gt_val_rx_pll {PLL0}\
      CONFIG.identical_val_rx_reference_clock {145.000}\
      CONFIG.gt0_val_tx_line_rate {2.900}\
      CONFIG.gt0_val_tx_int_datawidth {20}\
      CONFIG.gt0_val_tx_reference_clock {145.000}\
      CONFIG.gt0_val_rx_line_rate {2.900}\
      CONFIG.gt0_val_rx_data_width {16}\
      CONFIG.gt0_val_rx_int_datawidth {20}\
      CONFIG.gt0_val_rx_reference_clock {145.000}\
