...
#
# bare.tcl: Tcl script for re-creating project 'EcEvrProto_project'
#
# Generated by Vivado on Fri Sep 30 07:04:09 CEST 2022
...
#
# 1. This project restoration tcl script (bare.tcl) that was generated.
#
...
set script_file "genProject.tcl"
...
if { [info exists _opt_proj_name_] } {
  set _xil_proj_name_ ${_opt_proj_name_}
} elseif { [info exists ::user_project_name] } {
  set _xil_proj_name_ $::user_project_name
} elseif { ${_dev_board_} != 0 } {
  set _xil_proj_name_ "EcEvrDevBoard_project"
} else {
...
if { ${_dev_board_} != 0 } {
  ...
  set project_part   "xc7a35tcsg325-1"
}
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part ${project_part} -flow {Vivado Implementation 2021} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
